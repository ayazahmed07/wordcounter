...
if(countWords.length === 1){wordCountmessage = "1 word";}

else {wordCountmessage = `${countWords.length} words`;}


console.log(
  chalk.gray.bold(`"Your sentence word count is ${wordCountmessage} "`)
);
